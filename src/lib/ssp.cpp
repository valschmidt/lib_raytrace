...
vector< vector<double> > ssp::raytrace_simple(double z0, double x0, double theta0, double owtt)
{
    
    vector< vector<double> > outputs(2);

    return outputs; //[ [x1, x2, ...], [z1, z2, ...] ]
}

vector< vector<double> > ssp::raytrace_angle( vector<double> theta, vector<double> ttt)
{
